    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          { t: 'fig', layout: 'wide', items: [
            { src: '/studies/openci/cap-form.jpg', caption: 'Fig. 2. The form builder that made the configurable shape possible: a new investigation type is defined rather than released. Staging environment, mock data.', w: 1000, h: 405 },
          ] },
      ...
      },
      {
        ...
        blocks: [
          ...
          { t: 'fig', layout: 'phones', items: [
            { src: '/studies/openci/cap-route.jpg', caption: 'Fig. 3. One agent’s route as the office sees it.', w: 860, h: 621 },
          ...
          { t: 'fig', layout: 'wide', items: [
            { src: '/studies/openci/cap-dl.jpg', caption: 'Fig. 4. Endorsement management across the whole book. Borrower fields are masked at source. Staging environment, mock data.', w: 1000, h: 506 },
          ] },
          ...
          { t: 'fig', layout: 'pair', items: [
            { src: '/studies/openci/cap-anomaly.jpg', caption: 'Fig. 5. The concern queue. Every flag is a ticket a person reads.', w: 1000, h: 439 },
          ...
          { t: 'fig', layout: 'wide', items: [
            { src: '/studies/openci/cap-thresholds.jpg', caption: 'Fig. 6. Every rule is a number the operation owns, with a history of who changed it. Staging environment, mock data.', w: 900, h: 459 },
          ] },
        ],
      },
    ],
